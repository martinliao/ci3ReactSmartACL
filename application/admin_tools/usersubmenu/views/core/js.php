...
<script>
  $(document).ready(function() {
    ...
    $('#myData').DataTable({
      ...
      "order": [],
      "ajax": {
        "url": "<?= site_url('usersubmenu/getLists/'); ?>" + id_menu,
        "type": "POST"
      },
      "columnDefs": [{
        "targets": [0],
    ...
    $('#data').on('click',
      ...
      function() {
        ...
        $.ajax({
          url: '<?= site_url('usersubmenu/active') ?>',
          type: 'post',
          data: {
            id: id_menu,
            active: active
